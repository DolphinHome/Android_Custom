...
> 最后一个由 **原团队** 维护的版本，后续版本均有 QQ 团队接手

> 可以先安装 QQ，再用  "QQ一键登录" 来实现登录，[图文测评](https://mp.weixin.qq.com/s/qmUDm8bCVgvAgujEcB-dXw)
...
> 第一个支持  **阅读模式** 的版本，阅读界面使用的相对好看的衬线字体
...
---
**Android版 v7.14.40.4**  ![tuijian](https://gitee.com/ww3w/dzb/raw/master/icons/tuijian.svg)  
